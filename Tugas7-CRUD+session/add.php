                ...
                <div class="pr-5 pl-5 pt-3 pb-3 table100">
                    <form action="" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan kode barang" required minlength="5" maxlength="5">
                        <small id="emailHelp" class="form-text text-muted" style="color: red">5 Karakter*</small>
                      </div>
                      <div class="form-group">
                        <label for="nama">Nama barang</label>
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama barang" required minlength="3" maxlength="20" >
                      </div>
                      <div class="form-group">
